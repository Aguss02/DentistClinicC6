...
public class DentistServiceImpl implements DentistService {
    ...
    @Override
    public Dentist updateDentist(Dentist dentist) throws NotFoundException, BadRequestException {

        if (dentist == null){
            LOGGER.error("Dentist Is Null");
            throw new NotFoundException("Dentist was not found");
    ...
    @Override
    public void deleteDentist(long id) throws NotFoundException {
