...
public class PatientServiceImplTest {
    ...
    @Test
    public void findPatientsByIdTest() throws NotFoundException {
        Assertions.assertNotNull(patientService.findPatientById(1l));
    }

    @Test
    public void createPatientTest() throws BadRequestException, NotFoundException {
        Patient patient = new Patient("Test","Test","Fake city Test", 00001452, new Date());
    ...
    @Test
    public void deletePatientByIdExceptionTest() throws NotFoundException {
        patientService.deletePatient(1L);
    ...
    public void updateDentistTest() throws NotFoundException, BadRequestException {
        ...
        Patient updatedPatient = new Patient(1l,"Test","Updated","Fake city Test", 00001452, new Date());
        patientService.updatePatient(updatedPatient);

        // Check if the values for the Dentist are equal to the ones we made
        Assertions.assertTrue(patientService.findPatientById(1l).getName() == "Updated" || patientService.findPatientById(1l).getSurname() == "Test");
