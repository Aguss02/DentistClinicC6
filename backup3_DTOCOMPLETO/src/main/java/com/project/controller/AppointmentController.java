...
public class AppointmentController {
    ...
    @GetMapping("/{id}")
    public AppointmentDTO getAppointmentById(Long id) throws ResourceNotFoundException {
        return appointmentService.findAppointmentById(id);
    }

    @PostMapping("/add")
    public Appointment saveAppointment(@RequestBody Appointment appointment) throws BadRequestException {
